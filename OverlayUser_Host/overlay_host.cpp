// SharedMemUser_1.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, TCHAR *argv[])
{
   ...
   wchar_t second_process_name[80];
   swprintf(second_process_name, 80, L"OverlayUser_Remote.exe");
   
   hProcess = CreateChildProcess(second_process_name);

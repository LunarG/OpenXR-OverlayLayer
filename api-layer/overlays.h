...
// All applications within an overlay session must use the same version of the
// overlay layer to ensure compatibility, or the some RPC to share the main
// overlay's enum -> string map must be added.
enum WellKnownStringIndex {
    ...
    INPUT_GRIP_POSE = 11,
    INPUT_MENU_CLICK = 12,
    INPUT_MUTE_MIC_CLICK = 13,
    INPUT_SELECT_CLICK = 14,
    INPUT_SHOULDER_LEFT_CLICK = 15,
    INPUT_SHOULDER_RIGHT_CLICK = 16,
    INPUT_SQUEEZE_CLICK = 17,
    INPUT_SQUEEZE_FORCE = 18,
    INPUT_SQUEEZE_VALUE = 19,
    INPUT_SYSTEM_CLICK = 20,
    INPUT_SYSTEM_TOUCH = 21,
    INPUT_THUMBREST_TOUCH = 22,
    INPUT_THUMBSTICK = 23,
    INPUT_THUMBSTICK_CLICK = 24,
    INPUT_THUMBSTICK_TOUCH = 25,
    INPUT_THUMBSTICK_X = 26,
    INPUT_THUMBSTICK_Y = 27,
    INPUT_THUMBSTICK_LEFT = 28,
    INPUT_THUMBSTICK_LEFT_CLICK = 29,
    INPUT_THUMBSTICK_LEFT_X = 30,
    INPUT_THUMBSTICK_LEFT_Y = 31,
    INPUT_THUMBSTICK_RIGHT = 32,
    INPUT_THUMBSTICK_RIGHT_CLICK = 33,
    INPUT_THUMBSTICK_RIGHT_X = 34,
    INPUT_THUMBSTICK_RIGHT_Y = 35,
    INPUT_TRACKPAD = 36,
    INPUT_TRACKPAD_CLICK = 37,
    INPUT_TRACKPAD_FORCE = 38,
    INPUT_TRACKPAD_TOUCH = 39,
    INPUT_TRACKPAD_X = 40,
    INPUT_TRACKPAD_Y = 41,
    INPUT_TRIGGER_CLICK = 42,
    INPUT_TRIGGER_TOUCH = 43,
    INPUT_TRIGGER_VALUE = 44,
    INPUT_TRIGGER_LEFT_VALUE = 45,
    INPUT_TRIGGER_RIGHT_VALUE = 46,
    INPUT_VIEW_CLICK = 47,
    INPUT_VOLUME_DOWN_CLICK = 48,
    INPUT_VOLUME_UP_CLICK = 49,
    INPUT_X_CLICK = 50,
    INPUT_X_TOUCH = 51,
    INPUT_Y_CLICK = 52,
    INPUT_Y_TOUCH = 53,
    INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER = 54,
    INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER = 55,
    INTERACTION_PROFILES_HTC_VIVE_CONTROLLER = 56,
    INTERACTION_PROFILES_HTC_VIVE_PRO = 57,
    INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER = 58,
    INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER = 59,
    INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER = 60,
    INTERACTION_PROFILES_OCULUS_GO_CONTROLLER = 61,
    INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER = 62,
    INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER = 63,
    OUTPUT_HAPTIC = 64,
    OUTPUT_HAPTIC_LEFT = 65,
    OUTPUT_HAPTIC_LEFT_TRIGGER = 66,
    OUTPUT_HAPTIC_RIGHT = 67,
    OUTPUT_HAPTIC_RIGHT_TRIGGER = 68,
    USER_GAMEPAD = 69,
    USER_GAMEPAD_INPUT_A_CLICK = 70,
    USER_GAMEPAD_INPUT_B_CLICK = 71,
    USER_GAMEPAD_INPUT_DPAD_DOWN_CLICK = 72,
    USER_GAMEPAD_INPUT_DPAD_LEFT_CLICK = 73,
    USER_GAMEPAD_INPUT_DPAD_RIGHT_CLICK = 74,
    USER_GAMEPAD_INPUT_DPAD_UP_CLICK = 75,
    USER_GAMEPAD_INPUT_MENU_CLICK = 76,
    USER_GAMEPAD_INPUT_SHOULDER_LEFT_CLICK = 77,
    USER_GAMEPAD_INPUT_SHOULDER_RIGHT_CLICK = 78,
    USER_GAMEPAD_INPUT_THUMBSTICK_LEFT = 79,
    USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_CLICK = 80,
    USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_X = 81,
    USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_Y = 82,
    USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT = 83,
    USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_CLICK = 84,
    USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_X = 85,
    USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_Y = 86,
    USER_GAMEPAD_INPUT_TRIGGER_LEFT_VALUE = 87,
    USER_GAMEPAD_INPUT_TRIGGER_RIGHT_VALUE = 88,
    USER_GAMEPAD_INPUT_VIEW_CLICK = 89,
    USER_GAMEPAD_INPUT_X_CLICK = 90,
    USER_GAMEPAD_INPUT_Y_CLICK = 91,
    USER_GAMEPAD_OUTPUT_HAPTIC_LEFT = 92,
    USER_GAMEPAD_OUTPUT_HAPTIC_LEFT_TRIGGER = 93,
    USER_GAMEPAD_OUTPUT_HAPTIC_RIGHT = 94,
    USER_GAMEPAD_OUTPUT_HAPTIC_RIGHT_TRIGGER = 95,
    USER_HAND_LEFT = 96,
    USER_HAND_LEFT_INPUT_A_CLICK = 97,
    USER_HAND_LEFT_INPUT_A_TOUCH = 98,
    USER_HAND_LEFT_INPUT_AIM_POSE = 99,
    USER_HAND_LEFT_INPUT_B_CLICK = 100,
    USER_HAND_LEFT_INPUT_B_TOUCH = 101,
    USER_HAND_LEFT_INPUT_BACK_CLICK = 102,
    USER_HAND_LEFT_INPUT_GRIP_POSE = 103,
    USER_HAND_LEFT_INPUT_MENU_CLICK = 104,
    USER_HAND_LEFT_INPUT_SELECT_CLICK = 105,
    USER_HAND_LEFT_INPUT_SQUEEZE_CLICK = 106,
    USER_HAND_LEFT_INPUT_SQUEEZE_FORCE = 107,
    USER_HAND_LEFT_INPUT_SQUEEZE_VALUE = 108,
    USER_HAND_LEFT_INPUT_SYSTEM_CLICK = 109,
    USER_HAND_LEFT_INPUT_SYSTEM_TOUCH = 110,
    USER_HAND_LEFT_INPUT_THUMBREST_TOUCH = 111,
    USER_HAND_LEFT_INPUT_THUMBSTICK = 112,
    USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK = 113,
    USER_HAND_LEFT_INPUT_THUMBSTICK_TOUCH = 114,
    USER_HAND_LEFT_INPUT_THUMBSTICK_X = 115,
    USER_HAND_LEFT_INPUT_THUMBSTICK_Y = 116,
    USER_HAND_LEFT_INPUT_TRACKPAD = 117,
    USER_HAND_LEFT_INPUT_TRACKPAD_CLICK = 118,
    USER_HAND_LEFT_INPUT_TRACKPAD_FORCE = 119,
    USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH = 120,
    USER_HAND_LEFT_INPUT_TRACKPAD_X = 121,
    USER_HAND_LEFT_INPUT_TRACKPAD_Y = 122,
    USER_HAND_LEFT_INPUT_TRIGGER_CLICK = 123,
    USER_HAND_LEFT_INPUT_TRIGGER_TOUCH = 124,
    USER_HAND_LEFT_INPUT_TRIGGER_VALUE = 125,
    USER_HAND_LEFT_INPUT_X_CLICK = 126,
    USER_HAND_LEFT_INPUT_X_TOUCH = 127,
    USER_HAND_LEFT_INPUT_Y_CLICK = 128,
    USER_HAND_LEFT_INPUT_Y_TOUCH = 129,
    USER_HAND_LEFT_OUTPUT_HAPTIC = 130,
    USER_HAND_RIGHT = 131,
    USER_HAND_RIGHT_INPUT_A_CLICK = 132,
    USER_HAND_RIGHT_INPUT_A_TOUCH = 133,
    USER_HAND_RIGHT_INPUT_AIM_POSE = 134,
    USER_HAND_RIGHT_INPUT_B_CLICK = 135,
    USER_HAND_RIGHT_INPUT_B_TOUCH = 136,
    USER_HAND_RIGHT_INPUT_BACK_CLICK = 137,
    USER_HAND_RIGHT_INPUT_GRIP_POSE = 138,
    USER_HAND_RIGHT_INPUT_MENU_CLICK = 139,
    USER_HAND_RIGHT_INPUT_SELECT_CLICK = 140,
    USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK = 141,
    USER_HAND_RIGHT_INPUT_SQUEEZE_FORCE = 142,
    USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE = 143,
    USER_HAND_RIGHT_INPUT_SYSTEM_CLICK = 144,
    USER_HAND_RIGHT_INPUT_SYSTEM_TOUCH = 145,
    USER_HAND_RIGHT_INPUT_THUMBREST_TOUCH = 146,
    USER_HAND_RIGHT_INPUT_THUMBSTICK = 147,
    USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK = 148,
    USER_HAND_RIGHT_INPUT_THUMBSTICK_TOUCH = 149,
    USER_HAND_RIGHT_INPUT_THUMBSTICK_X = 150,
    USER_HAND_RIGHT_INPUT_THUMBSTICK_Y = 151,
    USER_HAND_RIGHT_INPUT_TRACKPAD = 152,
    USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK = 153,
    USER_HAND_RIGHT_INPUT_TRACKPAD_FORCE = 154,
    USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH = 155,
    USER_HAND_RIGHT_INPUT_TRACKPAD_X = 156,
    USER_HAND_RIGHT_INPUT_TRACKPAD_Y = 157,
    USER_HAND_RIGHT_INPUT_TRIGGER_CLICK = 158,
    USER_HAND_RIGHT_INPUT_TRIGGER_TOUCH = 159,
    USER_HAND_RIGHT_INPUT_TRIGGER_VALUE = 160,
    USER_HAND_RIGHT_OUTPUT_HAPTIC = 161,
    USER_HEAD = 162,
    USER_HEAD_INPUT_MUTE_MIC_CLICK = 163,
    USER_HEAD_INPUT_SYSTEM_CLICK = 164,
    USER_HEAD_INPUT_VOLUME_DOWN_CLICK = 165,
    USER_HEAD_INPUT_VOLUME_UP_CLICK = 166,

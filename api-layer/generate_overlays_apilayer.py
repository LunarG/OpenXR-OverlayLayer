...
from overlays_generator import OverlaysOutputGenerator
...
def makeGenOpts(args):
    ...
    # Source files generated for the overlays layer
    genOpts['xr_generated_overlays.cpp'] = [
          OverlaysOutputGenerator,
          AutomaticSourceGeneratorOptions(
            conventions       = conventions,
            filename          = 'xr_generated_overlays.cpp',
            directory         = directory,
            apiname           = 'openxr',
            profile           = None,
    ...
    genOpts['xr_generated_overlays.hpp'] = [
          OverlaysOutputGenerator,
          AutomaticSourceGeneratorOptions(
            conventions       = conventions,
            filename          = 'xr_generated_overlays.hpp',
            directory         = directory,
            apiname           = 'openxr',
            profile           = None,
            versions          = featuresPat,

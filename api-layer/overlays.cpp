...
std::vector<PlaceholderActionId> PlaceholderActionIds = {
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "aim/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE,
     USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "grip/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "select/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_SELECT_CLICK,
     USER_HAND_LEFT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "trackpad/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK,
     USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X,
     USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD,
     USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y,
     USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "aim/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "grip/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "select/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_SELECT_CLICK,
     USER_HAND_RIGHT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "trackpad/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK,
     USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X,
     USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD,
     USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y,
     USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "aim/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE,
     USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "grip/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "menu/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK,
     USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "squeeze/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE,
     USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X,
     USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y,
     USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE,
     USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/x/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_X_CLICK,
     USER_HAND_LEFT_INPUT_X_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/y/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_Y_CLICK,
     USER_HAND_LEFT_INPUT_Y_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC,
     USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "a/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK,
     USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "aim/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "b/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK,
     USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "grip/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "menu/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK,
     USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "squeeze/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE,
     USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE,
     USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC,
     USER_HAND_RIGHT_OUTPUT_HAPTIC},
    ...
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/menu/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK,
     USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/squeeze/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_CLICK,
     USER_HAND_LEFT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/system/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_CLICK,
     USER_HAND_LEFT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK,
     USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/"
     "x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X,
     USER_HAND_LEFT_INPUT_TRACKPAD_X},
    ...
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/"
     "y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y,
     USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trigger/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK,
     USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trigger/"
     "value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE,
     USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    ...
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/menu/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK,
     USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/squeeze/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_CLICK,
     USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/system/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK,
     USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK,
     USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/"
     "x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X,
     USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    ...
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/"
     "y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y,
     USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trigger/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK,
     USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trigger/"
     "value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE,
     USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    ...
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE,
     USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/menu/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK,
     USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/select/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_SELECT_CLICK,
     USER_HAND_LEFT_INPUT_SELECT_CLICK},
    ...
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/menu/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK,
     USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/select/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_SELECT_CLICK,
     USER_HAND_RIGHT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC,
     USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "aim/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE,
     USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "grip/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "menu/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK,
     USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "squeeze/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_CLICK,
     USER_HAND_LEFT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X,
     USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y,
     USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "trackpad/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK,
     USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X,
     USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD,
     USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y,
     USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE,
     USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC,
     USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "aim/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "grip/pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "menu/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK,
     USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "squeeze/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_CLICK,
     USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "trackpad/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK,
     USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X,
     USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD,
     USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y,
     USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE,
     USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC,
     USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/a/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_A_CLICK,
     USER_GAMEPAD_INPUT_A_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/b/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_B_CLICK,
     USER_GAMEPAD_INPUT_B_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "dpad_down/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_DOWN_CLICK,
     USER_GAMEPAD_INPUT_DPAD_DOWN_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "dpad_left/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_LEFT_CLICK,
     USER_GAMEPAD_INPUT_DPAD_LEFT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "dpad_right/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_RIGHT_CLICK,
     USER_GAMEPAD_INPUT_DPAD_RIGHT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "dpad_up/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_UP_CLICK,
     USER_GAMEPAD_INPUT_DPAD_UP_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/menu/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_MENU_CLICK,
     USER_GAMEPAD_INPUT_MENU_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "shoulder_left/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_SHOULDER_LEFT_CLICK,
     USER_GAMEPAD_INPUT_SHOULDER_LEFT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "shoulder_right/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_SHOULDER_RIGHT_CLICK,
     USER_GAMEPAD_INPUT_SHOULDER_RIGHT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_left/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT_CLICK,
     USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_left/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT_X,
     USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_X},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_left",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT,
     USER_GAMEPAD_INPUT_THUMBSTICK_LEFT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_left/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT_Y,
     USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_Y},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_right/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT_CLICK,
     USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_right/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT_X,
     USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_X},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_right",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT,
     USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "thumbstick_right/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT_Y,
     USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_Y},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "trigger_left/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_TRIGGER_LEFT_VALUE,
     USER_GAMEPAD_INPUT_TRIGGER_LEFT_VALUE},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/"
     "trigger_right/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_TRIGGER_RIGHT_VALUE,
     USER_GAMEPAD_INPUT_TRIGGER_RIGHT_VALUE},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/view/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_VIEW_CLICK,
     USER_GAMEPAD_INPUT_VIEW_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/x/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_X_CLICK,
     USER_GAMEPAD_INPUT_X_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/y/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_Y_CLICK,
     USER_GAMEPAD_INPUT_Y_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/"
     "haptic_left",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_LEFT,
    ...
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/"
     "haptic_right",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_RIGHT,
     USER_GAMEPAD_OUTPUT_HAPTIC_RIGHT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/"
     "haptic_right_trigger",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_RIGHT_TRIGGER,
    ...
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/back/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_BACK_CLICK,
     USER_HAND_LEFT_INPUT_BACK_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/system/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_CLICK,
     USER_HAND_LEFT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK,
     USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/"
     "x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X,
     USER_HAND_LEFT_INPUT_TRACKPAD_X},
    ...
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/"
     "y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y,
     USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trigger/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK,
     USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/back/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_BACK_CLICK,
     USER_HAND_RIGHT_INPUT_BACK_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/system/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK,
     USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/"
     "trackpad/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK,
     USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X,
     USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD,
     USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y,
     USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trigger/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK,
     USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE,
     USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/menu/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK,
     USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "squeeze/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE,
     USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "thumbrest/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBREST_TOUCH,
     USER_HAND_LEFT_INPUT_THUMBREST_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "thumbstick/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_TOUCH,
     USER_HAND_LEFT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X,
     USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y,
     USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "trigger/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_TOUCH,
     USER_HAND_LEFT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE,
     USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/x/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_X_CLICK,
     USER_HAND_LEFT_INPUT_X_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/x/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_X_TOUCH,
     USER_HAND_LEFT_INPUT_X_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/y/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_Y_CLICK,
     USER_HAND_LEFT_INPUT_Y_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/y/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_Y_TOUCH,
     USER_HAND_LEFT_INPUT_Y_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC,
     USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/a/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK,
     USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/a/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_A_TOUCH,
     USER_HAND_RIGHT_INPUT_A_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/b/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK,
     USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/b/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_B_TOUCH,
     USER_HAND_RIGHT_INPUT_B_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "squeeze/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE,
     USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "system/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK,
     USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "thumbrest/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBREST_TOUCH,
     USER_HAND_RIGHT_INPUT_THUMBREST_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "thumbstick/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_TOUCH,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "trigger/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_TOUCH,
     USER_HAND_RIGHT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE,
     USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC,
     USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/a/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_A_CLICK,
     USER_HAND_LEFT_INPUT_A_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/a/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_A_TOUCH,
     USER_HAND_LEFT_INPUT_A_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE,
     USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/b/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_B_CLICK,
     USER_HAND_LEFT_INPUT_B_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/b/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_B_TOUCH,
     USER_HAND_LEFT_INPUT_B_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE,
     USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "squeeze/force",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_FORCE,
     USER_HAND_LEFT_INPUT_SQUEEZE_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "squeeze/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE,
     USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/system/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_CLICK,
     USER_HAND_LEFT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/system/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_TOUCH,
     USER_HAND_LEFT_INPUT_SYSTEM_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "thumbstick/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_TOUCH,
     USER_HAND_LEFT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X,
     USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y,
     USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trackpad/force",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_FORCE,
     USER_HAND_LEFT_INPUT_TRACKPAD_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X,
     USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD,
     USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y,
     USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trigger/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK,
     USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trigger/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_TOUCH,
     USER_HAND_LEFT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE,
     USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC,
     USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/a/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK,
     USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/a/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_A_TOUCH,
     USER_HAND_RIGHT_INPUT_A_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/aim/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE,
     USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/b/"
     "click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK,
     USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/b/"
     "touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_B_TOUCH,
     USER_HAND_RIGHT_INPUT_B_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/grip/"
     "pose",
     XR_ACTION_TYPE_POSE_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE,
     USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "squeeze/force",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_FORCE,
     USER_HAND_RIGHT_INPUT_SQUEEZE_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "squeeze/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE,
     USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "system/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK,
     USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "system/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_TOUCH,
     USER_HAND_RIGHT_INPUT_SYSTEM_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "thumbstick/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "thumbstick/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_TOUCH,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "thumbstick/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "thumbstick",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "thumbstick/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trackpad/force",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_FORCE,
     USER_HAND_RIGHT_INPUT_TRACKPAD_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trackpad/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH,
     USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trackpad/x",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X,
     USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trackpad",
     XR_ACTION_TYPE_VECTOR2F_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD,
     USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trackpad/y",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y,
     USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trigger/click",
     XR_ACTION_TYPE_BOOLEAN_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK,
     USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trigger/touch",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_TOUCH,
     USER_HAND_RIGHT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/"
     "trigger/value",
     XR_ACTION_TYPE_FLOAT_INPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE,
     USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/output/"
     "haptic",
     XR_ACTION_TYPE_VIBRATION_OUTPUT, INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC,
     USER_HAND_RIGHT_OUTPUT_HAPTIC},

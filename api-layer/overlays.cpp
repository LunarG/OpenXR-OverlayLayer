...
void LogToFile(const char *str)
{
    ...
    if(!LogFile) {
        LogFile = fopen("overlays_logfile.txt", "w");
...
std::unordered_map<std::string, ProfileExtensionReqMask> ExtensionsBits = {
    {XR_EXT_EYE_GAZE_INTERACTION_EXTENSION_NAME, REQ_EXT_EYE_GAZE_INTERACTION_BIT},
    {XR_EXT_HP_MIXED_REALITY_CONTROLLER_EXTENSION_NAME, REQ_EXT_HP_MIXED_REALITY_CONTROLLER_BIT},
    {XR_EXT_SAMSUNG_ODYSSEY_CONTROLLER_EXTENSION_NAME, REQ_EXT_SAMSUNG_ODYSSEY_CONTROLLER_BIT},
    {XR_HTC_VIVE_COSMOS_CONTROLLER_INTERACTION_EXTENSION_NAME, REQ_HTC_VIVE_COSMOS_CONTROLLER_INTERACTION_BIT},
    {XR_MSFT_HAND_INTERACTION_EXTENSION_NAME, REQ_MSFT_HAND_INTERACTION_BIT}};

std::unordered_map<WellKnownStringIndex, ProfileExtensionReqMask> ProfileExtensions = {
    {INTERACTION_PROFILES_EXT_EYE_GAZE_INTERACTION, REQ_INTERACTION_PROFILES_EXT_EYE_GAZE_INTERACTION_MASK},
    {INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, REQ_INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER_MASK},
    {INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, REQ_INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER_MASK},
    {INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, REQ_INTERACTION_PROFILES_HTC_VIVE_CONTROLLER_MASK},
    {INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, REQ_INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER_MASK},
    {INTERACTION_PROFILES_HTC_VIVE_PRO, REQ_INTERACTION_PROFILES_HTC_VIVE_PRO_MASK},
    {INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, REQ_INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER_MASK},
    {INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, REQ_INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION_MASK},
    {INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, REQ_INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER_MASK},
    {INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, REQ_INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER_MASK},
    {INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, REQ_INTERACTION_PROFILES_OCULUS_GO_CONTROLLER_MASK},
    {INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, REQ_INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER_MASK},
    {INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, REQ_INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER_MASK},
    {INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, REQ_INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER_MASK}};
...
std::unordered_map<WellKnownStringIndex, const char*> OverlaysLayerWellKnownStrings = {
    ...
    {INPUT_GAZE_EXT_POSE, "/input/gaze_ext/pose"},
    ...
    {INPUT_SELECT_VALUE, "/input/select/value"},
    {INPUT_SHOULDER_CLICK, "/input/shoulder/click"},
    ...
    {INTERACTION_PROFILES_EXT_EYE_GAZE_INTERACTION, "/interaction_profiles/ext/eye_gaze_interaction"},
    {INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, "/interaction_profiles/google/daydream_controller"},
    {INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, "/interaction_profiles/hp/mixed_reality_controller"},
    {INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, "/interaction_profiles/htc/vive_controller"},
    {INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, "/interaction_profiles/htc/vive_cosmos_controller"},
    ...
    {INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, "/interaction_profiles/microsoft/hand_interaction"},
    ...
    {INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, "/interaction_profiles/samsung/odyssey_controller"},
    ...
    {USER_EYES_EXT, "/user/eyes_ext"},
    {USER_EYES_EXT_INPUT_GAZE_EXT_POSE, "/user/eyes_ext/input/gaze_ext/pose"},
    ...
    {USER_HAND_LEFT_INPUT_SELECT_VALUE, "/user/hand/left/input/select/value"},
    {USER_HAND_LEFT_INPUT_SHOULDER_CLICK, "/user/hand/left/input/shoulder/click"},
    ...
    {USER_HAND_RIGHT_INPUT_SELECT_VALUE, "/user/hand/right/input/select/value"},
    {USER_HAND_RIGHT_INPUT_SHOULDER_CLICK, "/user/hand/right/input/shoulder/click"},
...
std::vector<PlaceholderActionId> PlaceholderActionIds = {
    {"/interaction_profiles/ext/eye_gaze_interaction/user/eyes_ext/input/gaze_ext/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_EXT_EYE_GAZE_INTERACTION, USER_EYES_EXT, INPUT_GAZE_EXT_POSE, USER_EYES_EXT_INPUT_GAZE_EXT_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/select/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_SELECT_CLICK, USER_HAND_LEFT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK, USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH, USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X, USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD, USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/google/daydream_controller/user/hand/left/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y, USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/select/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_SELECT_CLICK, USER_HAND_RIGHT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK, USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH, USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X, USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD, USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/google/daydream_controller/user/hand/right/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_GOOGLE_DAYDREAM_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y, USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE, USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
    ...
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X, USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK, USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y, USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/x/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_X_CLICK, USER_HAND_LEFT_INPUT_X_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/input/y/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, INPUT_Y_CLICK, USER_HAND_LEFT_INPUT_Y_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/a/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK, USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/b/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK, USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK, USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE, USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X, USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK, USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y, USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/hp/mixed_reality_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_HP_MIXED_REALITY_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_CLICK, USER_HAND_LEFT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_CLICK, USER_HAND_LEFT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK, USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH, USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X, USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD, USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y, USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK, USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/htc/vive_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK, USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_CLICK, USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK, USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK, USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH, USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X, USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD, USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y, USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK, USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/htc/vive_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_HTC_VIVE_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/shoulder/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_SHOULDER_CLICK, USER_HAND_LEFT_INPUT_SHOULDER_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_CLICK, USER_HAND_LEFT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     ...
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/thumbstick/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_TOUCH,
     USER_HAND_LEFT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X, USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK, USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y, USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK, USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/x/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_X_CLICK, USER_HAND_LEFT_INPUT_X_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/input/y/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, INPUT_Y_CLICK, USER_HAND_LEFT_INPUT_Y_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/a/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK, USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/b/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK, USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/shoulder/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_SHOULDER_CLICK, USER_HAND_RIGHT_INPUT_SHOULDER_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_CLICK, USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK, USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/thumbstick/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_TOUCH,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X, USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK, USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y, USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK, USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/htc/vive_cosmos_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_HTC_VIVE_COSMOS_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/htc/vive_pro/user/head/input/mute_mic/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_PRO, USER_HEAD, INPUT_MUTE_MIC_CLICK, USER_HEAD_INPUT_MUTE_MIC_CLICK},
    {"/interaction_profiles/htc/vive_pro/user/head/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_PRO, USER_HEAD, INPUT_SYSTEM_CLICK, USER_HEAD_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/htc/vive_pro/user/head/input/volume_down/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_PRO, USER_HEAD, INPUT_VOLUME_DOWN_CLICK, USER_HEAD_INPUT_VOLUME_DOWN_CLICK},
    {"/interaction_profiles/htc/vive_pro/user/head/input/volume_up/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_HTC_VIVE_PRO, USER_HEAD, INPUT_VOLUME_UP_CLICK, USER_HEAD_INPUT_VOLUME_UP_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/input/select/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, INPUT_SELECT_CLICK, USER_HAND_LEFT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK, USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/input/select/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, INPUT_SELECT_CLICK, USER_HAND_RIGHT_INPUT_SELECT_CLICK},
    {"/interaction_profiles/khr/simple_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_KHR_SIMPLE_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/microsoft/hand_interaction/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/microsoft/hand_interaction/user/hand/left/input/select/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, USER_HAND_LEFT, INPUT_SELECT_VALUE, USER_HAND_LEFT_INPUT_SELECT_VALUE},
    {"/interaction_profiles/microsoft/hand_interaction/user/hand/left/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE, USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/microsoft/hand_interaction/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/microsoft/hand_interaction/user/hand/right/input/select/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, USER_HAND_RIGHT, INPUT_SELECT_VALUE, USER_HAND_RIGHT_INPUT_SELECT_VALUE},
    {"/interaction_profiles/microsoft/hand_interaction/user/hand/right/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_HAND_INTERACTION, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE, USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_CLICK, USER_HAND_LEFT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X, USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK, USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y, USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK, USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH, USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X, USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD, USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y, USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK, USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_CLICK, USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X, USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK, USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y, USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK, USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH, USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X, USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD, USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y, USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/microsoft/motion_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_MICROSOFT_MOTION_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/a/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_A_CLICK, USER_GAMEPAD_INPUT_A_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/b/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_B_CLICK, USER_GAMEPAD_INPUT_B_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/dpad_down/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_DOWN_CLICK, USER_GAMEPAD_INPUT_DPAD_DOWN_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/dpad_left/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_LEFT_CLICK, USER_GAMEPAD_INPUT_DPAD_LEFT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/dpad_right/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_RIGHT_CLICK, USER_GAMEPAD_INPUT_DPAD_RIGHT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/dpad_up/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_DPAD_UP_CLICK, USER_GAMEPAD_INPUT_DPAD_UP_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_MENU_CLICK, USER_GAMEPAD_INPUT_MENU_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/shoulder_left/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_SHOULDER_LEFT_CLICK,
     USER_GAMEPAD_INPUT_SHOULDER_LEFT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/shoulder_right/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_SHOULDER_RIGHT_CLICK,
     USER_GAMEPAD_INPUT_SHOULDER_RIGHT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_left/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT_CLICK,
     USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_left/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT_X, USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_X},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_left", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT, USER_GAMEPAD_INPUT_THUMBSTICK_LEFT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_left/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_LEFT_Y, USER_GAMEPAD_INPUT_THUMBSTICK_LEFT_Y},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_right/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT_CLICK,
     USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_right/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT_X, USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_X},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_right", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT, USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/thumbstick_right/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_THUMBSTICK_RIGHT_Y, USER_GAMEPAD_INPUT_THUMBSTICK_RIGHT_Y},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/trigger_left/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_TRIGGER_LEFT_VALUE, USER_GAMEPAD_INPUT_TRIGGER_LEFT_VALUE},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/trigger_right/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_TRIGGER_RIGHT_VALUE,
     USER_GAMEPAD_INPUT_TRIGGER_RIGHT_VALUE},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/view/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_VIEW_CLICK, USER_GAMEPAD_INPUT_VIEW_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/x/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_X_CLICK, USER_GAMEPAD_INPUT_X_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/input/y/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, INPUT_Y_CLICK, USER_GAMEPAD_INPUT_Y_CLICK},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/haptic_left", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_LEFT, USER_GAMEPAD_OUTPUT_HAPTIC_LEFT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/haptic_left_trigger", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_LEFT_TRIGGER,
     USER_GAMEPAD_OUTPUT_HAPTIC_LEFT_TRIGGER},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/haptic_right", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_RIGHT, USER_GAMEPAD_OUTPUT_HAPTIC_RIGHT},
    {"/interaction_profiles/microsoft/xbox_controller/user/gamepad/output/haptic_right_trigger", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_MICROSOFT_XBOX_CONTROLLER, USER_GAMEPAD, OUTPUT_HAPTIC_RIGHT_TRIGGER,
     USER_GAMEPAD_OUTPUT_HAPTIC_RIGHT_TRIGGER},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/back/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_BACK_CLICK, USER_HAND_LEFT_INPUT_BACK_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_CLICK, USER_HAND_LEFT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK, USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH, USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X, USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD, USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y, USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/oculus/go_controller/user/hand/left/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK, USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/back/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_BACK_CLICK, USER_HAND_RIGHT_INPUT_BACK_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK, USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK, USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH, USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X, USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD, USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y, USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/oculus/go_controller/user/hand/right/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_GO_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK, USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE, USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/thumbrest/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBREST_TOUCH, USER_HAND_LEFT_INPUT_THUMBREST_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK, USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/thumbstick/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_TOUCH, USER_HAND_LEFT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X, USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK, USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y, USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/trigger/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_TOUCH, USER_HAND_LEFT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/x/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_X_CLICK, USER_HAND_LEFT_INPUT_X_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/x/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_X_TOUCH, USER_HAND_LEFT_INPUT_X_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/y/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_Y_CLICK, USER_HAND_LEFT_INPUT_Y_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/input/y/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, INPUT_Y_TOUCH, USER_HAND_LEFT_INPUT_Y_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/a/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK, USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/a/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_A_TOUCH, USER_HAND_RIGHT_INPUT_A_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/b/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK, USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/b/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_B_TOUCH, USER_HAND_RIGHT_INPUT_B_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE, USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK, USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/thumbrest/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBREST_TOUCH, USER_HAND_RIGHT_INPUT_THUMBREST_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK, USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/thumbstick/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_TOUCH, USER_HAND_RIGHT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X, USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK, USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y, USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/trigger/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_TOUCH, USER_HAND_RIGHT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/oculus/touch_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_OCULUS_TOUCH_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_MENU_CLICK, USER_HAND_LEFT_INPUT_MENU_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_CLICK, USER_HAND_LEFT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X, USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK, USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y, USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_CLICK, USER_HAND_LEFT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH, USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X, USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD, USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y, USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/menu/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_MENU_CLICK, USER_HAND_RIGHT_INPUT_MENU_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/squeeze/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_CLICK, USER_HAND_RIGHT_INPUT_SQUEEZE_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK,
     USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X, USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK, USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y, USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/trackpad/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_CLICK, USER_HAND_RIGHT_INPUT_TRACKPAD_CLICK},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH, USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X, USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD, USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y, USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/samsung/odyssey_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_SAMSUNG_ODYSSEY_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/a/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_A_CLICK, USER_HAND_LEFT_INPUT_A_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/a/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_A_TOUCH, USER_HAND_LEFT_INPUT_A_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_AIM_POSE, USER_HAND_LEFT_INPUT_AIM_POSE},
    ...
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/b/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_B_TOUCH, USER_HAND_LEFT_INPUT_B_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_GRIP_POSE, USER_HAND_LEFT_INPUT_GRIP_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/squeeze/force", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_FORCE, USER_HAND_LEFT_INPUT_SQUEEZE_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SQUEEZE_VALUE, USER_HAND_LEFT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_CLICK, USER_HAND_LEFT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/system/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_SYSTEM_TOUCH, USER_HAND_LEFT_INPUT_SYSTEM_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_CLICK, USER_HAND_LEFT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/thumbstick/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_TOUCH, USER_HAND_LEFT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_X, USER_HAND_LEFT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK, USER_HAND_LEFT_INPUT_THUMBSTICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_THUMBSTICK_Y, USER_HAND_LEFT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trackpad/force", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_FORCE, USER_HAND_LEFT_INPUT_TRACKPAD_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_TOUCH, USER_HAND_LEFT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_X, USER_HAND_LEFT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD, USER_HAND_LEFT_INPUT_TRACKPAD},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRACKPAD_Y, USER_HAND_LEFT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_CLICK, USER_HAND_LEFT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trigger/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_TOUCH, USER_HAND_LEFT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/left/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, INPUT_TRIGGER_VALUE, USER_HAND_LEFT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/left/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_LEFT, OUTPUT_HAPTIC, USER_HAND_LEFT_OUTPUT_HAPTIC},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/a/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_A_CLICK, USER_HAND_RIGHT_INPUT_A_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/a/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_A_TOUCH, USER_HAND_RIGHT_INPUT_A_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/aim/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_AIM_POSE, USER_HAND_RIGHT_INPUT_AIM_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/b/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_B_CLICK, USER_HAND_RIGHT_INPUT_B_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/b/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_B_TOUCH, USER_HAND_RIGHT_INPUT_B_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/grip/pose", XR_ACTION_TYPE_POSE_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_GRIP_POSE, USER_HAND_RIGHT_INPUT_GRIP_POSE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/squeeze/force", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_FORCE, USER_HAND_RIGHT_INPUT_SQUEEZE_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/squeeze/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SQUEEZE_VALUE, USER_HAND_RIGHT_INPUT_SQUEEZE_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/system/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_CLICK, USER_HAND_RIGHT_INPUT_SYSTEM_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/system/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_SYSTEM_TOUCH, USER_HAND_RIGHT_INPUT_SYSTEM_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/thumbstick/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_CLICK, USER_HAND_RIGHT_INPUT_THUMBSTICK_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/thumbstick/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_TOUCH, USER_HAND_RIGHT_INPUT_THUMBSTICK_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/thumbstick/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_X, USER_HAND_RIGHT_INPUT_THUMBSTICK_X},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/thumbstick", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK, USER_HAND_RIGHT_INPUT_THUMBSTICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/thumbstick/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_THUMBSTICK_Y, USER_HAND_RIGHT_INPUT_THUMBSTICK_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trackpad/force", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_FORCE, USER_HAND_RIGHT_INPUT_TRACKPAD_FORCE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trackpad/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_TOUCH, USER_HAND_RIGHT_INPUT_TRACKPAD_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trackpad/x", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_X, USER_HAND_RIGHT_INPUT_TRACKPAD_X},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trackpad", XR_ACTION_TYPE_VECTOR2F_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD, USER_HAND_RIGHT_INPUT_TRACKPAD},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trackpad/y", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRACKPAD_Y, USER_HAND_RIGHT_INPUT_TRACKPAD_Y},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trigger/click", XR_ACTION_TYPE_BOOLEAN_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_CLICK, USER_HAND_RIGHT_INPUT_TRIGGER_CLICK},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trigger/touch", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_TOUCH, USER_HAND_RIGHT_INPUT_TRIGGER_TOUCH},
    {"/interaction_profiles/valve/index_controller/user/hand/right/input/trigger/value", XR_ACTION_TYPE_FLOAT_INPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, INPUT_TRIGGER_VALUE, USER_HAND_RIGHT_INPUT_TRIGGER_VALUE},
    {"/interaction_profiles/valve/index_controller/user/hand/right/output/haptic", XR_ACTION_TYPE_VIBRATION_OUTPUT,
     INTERACTION_PROFILES_VALVE_INDEX_CONTROLLER, USER_HAND_RIGHT, OUTPUT_HAPTIC, USER_HAND_RIGHT_OUTPUT_HAPTIC},
};
...
using ExtensionMask = std::underlying_type_t<ProfileExtensionReqMask>;
ExtensionMask CreateExtensionMask(const XrInstanceCreateInfo& info) {
    ExtensionMask mask = REQ_EXTENSION_NONE_MASK;
    for (uint32_t i = 0; i < info.enabledExtensionCount; i++) {
        const auto it = ExtensionsBits.find(info.enabledExtensionNames[i]);
        if (it != ExtensionsBits.cend()) {
            mask |= static_cast<ExtensionMask>(it->second);
        }
    }
    return mask;
}

bool ProfileIsSupported(ExtensionMask ext_mask, WellKnownStringIndex profile_index) {
    const ExtensionMask required_ext = ProfileExtensions[profile_index];
    return (required_ext & ext_mask) == required_ext;
}
...
static std::map<DXGI_FORMAT, DXGI_FORMAT> TypedFormatToTypelessFormat = {
                         ...
                         const std::set<HandleTypePair>& objects_info, const char* message)
{
    ...
    if(instance != XR_NULL_HANDLE) {
        ...
        if (!instanceInfo->debugUtilsMessengers.empty()) {
            ...
            if(AlsoLogToFile) {
                LogToFile(fmt("Overlays API Layer: %s, %s\n", command_name ? command_name : "null", message).c_str());
            }
        } else {
            if(command_name) {
                ...
                if(AlsoLogToFile) {
                    LogToFile(fmt("Overlays API Layer: %s\n", message).c_str());
                }
            }
        }
    } else {
        ...
        const struct XrApiLayerCreateInfo *apiLayerInfo, XrInstance *instance)
{
    ...
    *instance = returned_instance;
    ...
    const auto extension_mask = CreateExtensionMask(*instanceInfo->createInfo);
    for(auto& id : PlaceholderActionIds) {
        if (!ProfileIsSupported(extension_mask, id.interactionProfileString)) continue;  // Skip unsupported paths
...
XrResult OverlaysLayerCreateSession(XrInstance instance, const XrSessionCreateInfo* createInfo, XrSession* session)
{
    ...
    try{
        ...
        if(!cio) {
            if(PrintDebugInfo) OverlaysLayerLogMessage(XR_NULL_HANDLE, XR_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT, "xrCreateSession", OverlaysLayerNoObjectInfo, "Creating Main Session");  // XXX DEBUG
            result = OverlaysLayerCreateSessionMain(instance, createInfo, session, d3dbinding->device);
            if(PrintDebugInfo) OverlaysLayerLogMessage(XR_NULL_HANDLE, XR_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT, "xrCreateSession", OverlaysLayerNoObjectInfo, fmt("result of Create Main Session is %d, session is %08X", result, *session).c_str());  // XXX DEBUG
        } else {
            if(PrintDebugInfo) OverlaysLayerLogMessage(XR_NULL_HANDLE, XR_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT, "xrCreateSession", OverlaysLayerNoObjectInfo, "Creating Overlay Session");  // XXX DEBUG
            result = OverlaysLayerCreateSessionOverlay(instance, createInfo, session, cio, d3dbinding->device);
            if(PrintDebugInfo) OverlaysLayerLogMessage(XR_NULL_HANDLE, XR_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT, "xrCreateSession", OverlaysLayerNoObjectInfo, fmt("result of Create Overlay Session is %d, session is %08X", result, *session).c_str());  // XXX DEBUG
        }
    ...
    for(auto profileAndBindings : instanceInfo->profilesToBindings) {
...

        {
            ...
            OverlaysLayerLogMessage(sessionInfo->parentInstance, XR_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT, "xrAttachSessionActionSets",
                OverlaysLayerNoObjectInfo,
                fmt("interactionProfile \"%s\"", PathToString(sessionInfo->parentInstance, interactionProfile).c_str()).c_str());
